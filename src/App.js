        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '3rem 2rem' }}>
          {selectedPost && (
            <article>
              ...
              <div style={{ background: colors.primaryLight, padding: '1.5rem', borderRadius: '8px', marginTop: '2rem', borderLeft: `4px solid ${colors.accent}` }}>
                ...
                <a href="https://www.linkedin.com/in/wesley-d-551a019b/" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', fontSize: '14px', color: colors.accent, textDecoration: 'none', fontWeight: '500', borderBottom: `1px solid ${colors.accent}` }}>Connect op LinkedIn →</a>
              </div>
            </article>
          )}
        </div>
      ...
      <div style={{ minHeight: '100vh', background: colors.background }}>
        <nav style={{ borderBottom: `1px solid ${colors.border}`, padding: '1.5rem 2rem', position: 'sticky', top: 0, background: colors.primary, zIndex: 10 }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button onClick={() => { setCurrentPage('handleidingen'); setSelectedHandleidingId(null); }} style={{ background: colors.accent, color: colors.white, border: 'none', padding: '10px 16px', borderRadius: '6px', cursor: 'pointer', fontSize: '14px', fontWeight: '500' }}>← Terug naar Handleidingen</button>
          </div>
        </nav>
        ...
        {currentPage === 'home' && (
          <div style={{ paddingTop: '4rem', paddingBottom: '4rem' }}>
            <div style={{ maxWidth: '700px' }}>
              ...
              {featuredPost && (
                <div style={{ padding: '2.5rem', background: `linear-gradient(135deg, ${colors.primary} 0%, ${colors.primaryDark} 100%)`, borderRadius: '12px', color: colors.white, marginBottom: '3rem', cursor: 'pointer', boxShadow: '0 4px 12px rgba(30, 64, 175, 0.25)' }} onClick={() => setSelectedPostId(featuredPost.id)}>
                  <div style={{ background: colors.accent, display: 'inline-block', padding: '6px 14px', borderRadius: '20px', fontSize: '12px', fontWeight: '700', marginBottom: '1rem', letterSpacing: '0.5px' }}>⭐ UITGELICHT ARTIKEL</div>
          ...
          <div style={{ paddingTop: '3rem', paddingBottom: '3rem' }}>
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
              ...
              <div style={{ background: `linear-gradient(135deg, ${colors.primary} 0%, ${colors.primaryDark} 100%)`, padding: '2rem', borderRadius: '12px', color: colors.white, textAlign: 'center' }}>
                ...
                <a href="https://www.linkedin.com/in/wesley-d-551a019b/" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', padding: '12px 28px', background: colors.accent, color: colors.white, textDecoration: 'none', borderRadius: '6px', fontSize: '14px', fontWeight: '600', boxShadow: '0 2px 8px rgba(249, 115, 22, 0.3)' }}>Connect op LinkedIn →</a>
              </div>
            </div>
          </div>
        )}
